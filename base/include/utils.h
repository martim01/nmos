...
extern std::optional<std::chrono::time_point<std::chrono::high_resolution_clock>> ConvertTaiStringToTimePoint(const std::string& sTai);
...
extern std::optional<bool> GetBool(const Json::Value& jsObject, const std::string& sKey);
extern std::optional<std::string> GetString(const Json::Value& jsObject, const std::string& sKey);
extern std::optional<uint32_t> GetUInt(const Json::Value& jsObject, const std::string& sKey) ;
extern std::optional<int32_t> GetInt(const Json::Value& jsObject, const std::string& sKey) ;
extern std::optional<double> GetDouble(const Json::Value& jsObject, const std::string& sKey) ;
extern std::optional<int64_t> GetInt64(const Json::Value& jsObject, const std::string& sKey) ;
extern std::optional<uint64_t> GetUInt64(const Json::Value& jsObject, const std::string& sKey) ;
