...
static void ActivationThread(pml::nmos::Activator* pActivator)
{
    while(pActivator->IsRunning() && pActivator->ActivationsPending())
    {
        ...
        {
            //reset time
            pml::log::log(pml::log::Level::kDebug, "pml::nmos") << "NMOS: ActivationThread - reset time";
        }
    }
