...
pml::restgoose::response NotFound(const httpMethod& theMethod, const query& theQuery, const postData& theData, const endpoint& theEndpoint, const userName& theUser)
{
